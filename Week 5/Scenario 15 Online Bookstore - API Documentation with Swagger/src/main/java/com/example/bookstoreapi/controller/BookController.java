...
public class BookController {
    ...
    //Annotations are used to enhance API documentation code as required by Excercise 15
    
    @Operation(summary = "Get all books", description = "Fetch a list of all books available in the bookstore")
    @ApiResponses(value = {
